...
class CollapsingListTileAdmin extends StatefulWidget {
  ...
  CollapsingListTileAdmin(
      {  @required this.title,
        ...
        this.onTap});
  @override
  _CollapsingListTileAdminState createState() => _CollapsingListTileAdminState();
}
class _CollapsingListTileAdminState extends State<CollapsingListTileAdmin> {
